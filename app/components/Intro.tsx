...
function SidebarIcon({ name }: { name: SidebarIconName }) {
  ...
  const icons = {
    ...
    shared: (
      <>
        <path
          d="M2.9 6.5h5l1.35-1.75h3.15c.8 0 1.25.36 1.6 1.1l.25.65"
          {...common}
        />
        <path
          d="M3.05 7.1h10.15c.9 0 1.4.62 1.2 1.5l-.88 4.05c-.15.75-.63 1.1-1.4 1.1H3.9c-.82 0-1.25-.42-1.08-1.25l.95-4.25c.13-.7.55-1.15 1.28-1.15Z"
          {...common}
        />
        <circle
          cx="13.7"
        ...
        />
        <path
          d="M11.75 15.05c.35-1.15 1.02-1.72 1.95-1.72.92 0 1.58.57 1.94 1.72"
          {...common}
        />
      </>
    ),
    ...
    applications: (
      <>
        <path
          d="m6.05 14.8 6.05-10.25c.28-.48.98-.48 1.26 0l2.55 4.32"
          {...common}
        />
    ...
    documents: (
      <>
        <path
          d="M5.1 2.8h6.45l3.35 3.35v10.2c0 .83-.52 1.3-1.35 1.3H5.1c-.83 0-1.3-.47-1.3-1.3V4.1c0-.83.47-1.3 1.3-1.3Z"
          {...common}
        />
        <path
          d="M11.5 2.95V6.3h3.3M6.75 10.05h6.5M6.75 13h5.15"
          {...common}
        />
      </>
    ),
    ...
    downloads: (
      <>
        ...
        <path
          d="M10 5.4v6.3M7.6 9.55 10 11.95l2.4-2.4M6.7 14.45h6.6"
          {...common}
        />
      </>
    ),
...
function ToolbarIcon({ name }: { name: ToolbarIconName }) {
  ...
  const icons = {
    ...
    grid: (
      <>
        <rect x="3" y="3" width="5" height="5" rx=".8" {...props} />
        <rect x="12" y="3" width="5" height="5" rx=".8" {...props} />
        <rect x="3" y="12" width="5" height="5" rx=".8" {...props} />
        <rect x="12" y="12" width="5" height="5" rx=".8" {...props} />
      </>
    ),

    list: (
      <>
        <path d="M8 5h9M8 10h9M8 15h9" {...props} />
        <rect x="3" y="4" width="2" height="2" rx=".4" {...props} />
        <rect x="3" y="9" width="2" height="2" rx=".4" {...props} />
        <rect x="3" y="14" width="2" height="2" rx=".4" {...props} />
      </>
    ),
    ...
    share: (
      <>
        <path d="M10 13V3" {...props} />
        <path d="m6.5 6.5 3.5-3.5 3.5 3.5" {...props} />
        <path
          d="M5 9.5v6.25c0 .7.55 1.25 1.25 1.25h7.5c.7 0 1.25-.55 1.25-1.25V9.5"
          {...props}
        />
      </>
    ),
    ...
    tag: (
      <>
        <path
          d="M3 9.2V4.5c0-.83.67-1.5 1.5-1.5h4.7L17 10.8a1.7 1.7 0 0 1 0 2.4l-3.8 3.8a1.7 1.7 0 0 1-2.4 0L3 9.2Z"
          {...props}
        />
        <circle
          cx="6.3"
    ...
    search: (
      <>
        <circle cx="8.5" cy="8.5" r="4.8" {...props} />
        <path d="m12 12 4 4" {...props} />
      </>
    ),
  }
